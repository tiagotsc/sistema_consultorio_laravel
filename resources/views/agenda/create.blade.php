    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="dadosPaciente" class="row">
            ...
            {!! Form::text('telefone', '', ['class' => 'form-control telefone', 'placeholder' => 'Preencha...']) !!}
            </div>
            <div class="form-group col-md-2">
            {!! Form::label('celular', 'Celular') !!}
            {!! Form::text('celular', '', ['class' => 'form-control celular', 'placeholder' => 'Preencha...']) !!}
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="salvarConsultar" class="btn btn-primary">Marcar</button>
      </div>
      {!! Form::close() !!}
    </div>
</div>
